...
Продукт говорит по-русски и по-английски. Выбор — `NN_LANG=ru` либо `NN_LANG=en`; без переменной язык берётся из `LC_ALL`/`LANG`, иначе английский. Это касается справки команд, сообщений, заголовков таблиц и заметок в манифестах.
